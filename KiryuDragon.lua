...
v.Value = "Essence of Sumo Slapping‎"
v.Name = "MoveName"
...
game.ReplicatedStorage.Moves.H_SpinCounterBack.Closest.Value = 1000
game:GetService("ReplicatedStorage").Styles.Holding.H_Standing.Value = "H_Blunt"
game:GetService("ReplicatedStorage").Styles.Holding.H_Fallen.Value = "H_FallenStomp"
game:GetService("ReplicatedStorage").Styles.Holding.Rush1.Value = "MAttack1"
game:GetService("ReplicatedStorage").Styles.Holding.Rush2.Value = "MAttack2"
game:GetService("ReplicatedStorage").Styles.Holding.Rush3.Value = "MAttack3"
game:GetService("ReplicatedStorage").Styles.Holding.Strike1.Value = "FStrike4"